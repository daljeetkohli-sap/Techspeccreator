...
- Confirm Process Flow also includes a Technical Flow Diagram: Preview, Confluence copy, and the downloaded Word file should show a proper green-and-black flowchart diagram generated from the inferred process steps.
