...
- Enter a document version and revision summary, then confirm the header metadata and Revision History table appear in Preview, Word export, and Confluence copy.
...
- Confirm Process Flow also includes a Technical Flow Diagram: Preview, Confluence copy, and the downloaded Word file should show a compact green-and-black flowchart with segregated technical actions, not only broad high-level process labels.
