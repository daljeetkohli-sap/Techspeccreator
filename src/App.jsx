...
<html xmlns:o="urn:schemas-microsoft-com:office:office"
  ...
  <head>
    ...
    <style>
      ...
      .fair-logo .mark { display: inline-block; background: #12343b; color: #ffffff; font-size: 24pt; font-weight: 900; letter-spacing: 0; padding: 8px 12px; }
      .fair-logo .name { display: block; color: #12343b; font-size: 10pt; font-weight: 900; margin-top: 4px; letter-spacing: 0; }
      .fair-logo .tagline { display: block; color: #52646f; font-size: 9pt; margin-top: 2px; }
  ...
  <body>
    <div class="brandbar">
      <div class="fair-logo">
        <span class="mark">FAIR</span>
        <span class="name">CONSULTING GROUP</span>
